...
async function uploadToSnack() {
  ...
  snackDependencies['react'] = {version: '19.1.0'}
  snackDependencies['expo-font'] = {version: '~14.0.11'}
  snackDependencies['react-dom'] = {version: '19.1.0'}
  snackDependencies['expo-image'] = {version: '~3.0.11'}
  snackDependencies['expo-router'] = {version: '~6.0.23'}
  snackDependencies['expo-linking'] = {version: '~8.0.12'}
  snackDependencies['react-native'] = {version: '0.81.5'}
  snackDependencies['expo-constants'] = {version: '~18.0.13'}
  snackDependencies['expo-status-bar'] = {version: '~3.0.9'}
  snackDependencies['expo-router/head'] = {version: '~6.0.23'}
  snackDependencies['react-native-web'] = {version: '~0.21.0'}
  snackDependencies['@expo/vector-icons'] = {version: '^15.0.3'}
  snackDependencies['react-native-screens'] = {version: '~4.16.0'}
  snackDependencies['expo-screen-orientation'] = {version: '~9.0.9'}
  snackDependencies['react-native-gesture-handler'] = {version: '~2.28.0'}
  snackDependencies['react-native-safe-area-context'] = {version: '~5.6.0'}
  ...
  if (!['production', 'development'].includes(nodeEnv)) {
    throw new Error(
      `No or wrong NODE_ENV provided in environment variables. use NODE_ENV=<development|production> instead of NODE_ENV=${
        nodeEnv
      }`,
    )
  }
